...
gdf_processed <- gdf_filtered %>%
  mutate(
    ...
    GROUP_CD = case_when(
      ...
      # [병합] 율곡동 통합: 남면(37030320) -> 율곡동(37030620)
      ADM_CD == "37030320" ~ "37030620",
...
g1 <- ggplot(data = gdf_joined) +
  ...
  labs(
    title = "2024년 읍면동별 총인구",
    subtitle = "경상북도(영양/청송/울릉 제외) + 영동군 + 군위군",
